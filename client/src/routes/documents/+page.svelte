...
<div class="flex flex-row justify-between items-center my-4">
	<h2 class="text-3xl font-bold m-2">Ваши документы</h2>
	<div class="">
		<a
			href="/documents/new"
				...
				<table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
					<thead class="bg-gray-50">
						<tr>
							<th
								scope="col"
								class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Имя</th
							>
							<th
								scope="col"
							...
							<th
								scope="col"
								class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Действие</th
							>
						</tr>
					</thead>
